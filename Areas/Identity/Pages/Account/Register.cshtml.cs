...
namespace RopeyDVDSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength (255, ErrorMessage = "The First name field needs to have max character 255")]
            [Display (Name = "First Name")]
            public string FirstName { get; set; }

            [Required]
            [StringLength(255, ErrorMessage = "The Last name field needs to have max character 255")]
